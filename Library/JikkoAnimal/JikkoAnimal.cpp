...
void playBuzzerMusic(int music, int sec)
{
    ...
    {
    case 0:
        playMelody(bearMelody, sizeof(bearMelody), musicTempo[music], sec);
        break;
    case 1:
        playMelody(circleMelody, sizeof(circleMelody), musicTempo[music], sec);
        break;
    case 2:
        playMelody(tigerMelody, sizeof(tigerMelody), musicTempo[music], sec);
        break;
    case 3:
        playMelody(rudolfMelody, sizeof(rudolfMelody), musicTempo[music], sec);
        break;
    case 4:
        playMelody(starMelody, sizeof(starMelody), musicTempo[music], sec);
        break;
    case 5:
        playMelody(takeonmeMelody, sizeof(takeonmeMelody), musicTempo[music], sec);
        break;
    case 6:
        playMelody(pacmanMelody, sizeof(pacmanMelody), musicTempo[music], sec);
        break;
    case 7:
        playMelody(cannonMelody, sizeof(cannonMelody), musicTempo[music], sec);
        break;
    case 8:
        playMelody(odetojoyMelody, sizeof(odetojoyMelody), musicTempo[music], sec);
        break;
    case 9:
        playMelody(pinnkpantherMelody, sizeof(pinnkpantherMelody), musicTempo[music], sec);
        break;
    case 10:
        playMelody(harrypotterMelody, sizeof(harrypotterMelody), musicTempo[music], sec);
        break;
    }
}
